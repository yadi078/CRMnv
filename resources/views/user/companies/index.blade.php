                    ...
                    <tbody class="divide-y divide-white/15">
                        ...
                        <tr class="panel-card-dark__row hover:bg-white/8 transition-colors">
                            ...
                            <td class="px-6 py-4 align-top whitespace-nowrap text-sm font-medium">
                                ...
                                <form action="{{ route('companies.request-deletion', $company) }}" method="POST" class="inline-flex mr-3"
                                    onsubmit="return confirm('¿Enviar solicitud para eliminar esta empresa? Un administrador deberá aprobarlo.');">
                                    @csrf
                                    <button
                                        type="submit"
                                        class="text-amber-200 hover:text-amber-100 inline-flex items-center gap-1"
                                    >
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
