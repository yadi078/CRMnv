<x-app-user-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center flex-wrap gap-4">
            <div class="view-header">
                <div class="view-header__avatar" aria-hidden="true">
                    @if (Auth::user()->profile_photo_url)
                        <img src="{{ Auth::user()->profile_photo_url }}" alt="" class="view-header__avatar-img" />
                    @else
                        <span class="view-header__avatar-initials">{{ Auth::user()->initials }}</span>
                    @endif
                </div>
                <div>
    ...
    <div class="space-y-8">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="view-card view-card--azul">
