            ...
            >
                ...
                <form method="POST" action="{{ route('executives.store') }}" class="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="reg_exec_password" name="password" type="password" class="mt-1 block w-full bg-white/10 border-white/20 text-white" required autocomplete="new-password" />
                        <x-input-error :messages="$errors->get('password')" class="mt-2" />
                    </div>
                    <div>
                        <x-input-label for="reg_exec_password_confirmation" value="Confirmar contraseña" class="text-white/90" />
                        <x-text-input id="reg_exec_password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full bg-white/10 border-white/20 text-white" required autocomplete="new-password" />
                    </div>
