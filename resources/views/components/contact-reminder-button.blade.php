...
<div {{ $attributes->class(['inline-flex']) }} x-data="{ showReminderModal: {{ old('reminder_context') ? 'true' : 'false' }} }">
    <button
        ...
        class="inline-flex h-11 min-h-[44px] shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-[#FFE600] bg-[#0b386a] px-3 text-sm font-semibold text-[#FFE600] shadow-sm transition-colors hover:bg-[#082f59] sm:px-4"
    >
