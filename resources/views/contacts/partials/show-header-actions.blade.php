...
<div class="flex flex-wrap items-center gap-2">
    @unless($hideGenerarFichaEnCabecera)
        @can('sales.create')
            <a href="{{ $nuevaVentaDesdeContactoUrl }}" class="btn-amber-app inline-flex items-center gap-2 shrink-0">
    ...
    @endunless
    @can('contacts.edit')
        <a href="{{ \App\Support\CrmNavigation::withReturn(route('contacts.edit', $contact)) }}" class="btn-amber-app shrink-0">
    ...
    @can('delete', $contact)
        ...
        >
            @csrf
            @method('DELETE')
            <button type="submit" class="btn-danger-app sm:whitespace-nowrap">
    ...
    @can('requestDeletion', $contact)
        ...
        <button
            type="button"
            class="btn-danger-app max-w-full shrink-0 sm:whitespace-nowrap"
