@php
    $contactSales = $contactSales ?? null;
@endphp
...
<div class="panel-card-dark p-6">
    <h3 class="panel-card-dark__title panel-card-dark__title--accent mb-6 !text-2xl md:!text-3xl !font-extrabold tracking-tight">Información del Contacto</h3>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="flex items-center justify-between mb-1">
                <p class="text-base text-white/70">Notas</p>
                @can('contacts.edit')
                <button
                    type="button"
...
@if($contactSales !== null)
    @include('contacts.partials.contact-sales-history', [
        'contact' => $contact,
        'sales' => $contactSales,
        'formAction' => route('contacts.show', $contact),
        'showPanelTitle' => true,
    ])
@endif
