    ...
    <x-slot name="header">
        ...
        <div class="flex flex-wrap gap-2 ml-auto justify-end items-center">
                ...
                @can('generatePdf', $contact)
                    <a href="{{ route('contacts.pdf', $contact) }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white/15 text-white border border-[#FFE600]/50 hover:bg-white/25 text-sm font-semibold" title="Descargar ficha en PDF">
