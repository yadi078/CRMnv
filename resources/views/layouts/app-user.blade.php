    ...
    <body class="font-sans antialiased">
        <div class="sidebar-layout">
            ...
            <div class="sidebar-layout__main">
                <header class="flex items-center justify-between h-14 px-4 sm:px-6 border-b border-white/10 bg-[#0A1A3F]/50">
                    <div class="flex items-center gap-3">
                        <a href="{{ route('user.dashboard') }}" class="flex items-center gap-2 no-underline group">
                            <img
                ...
                @isset($header)
                    <div class="sidebar-layout__header px-4 sm:px-6 py-4 bg-gradient-to-b from-[#0A1A3F] to-[#102A6B]">
