...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased text-fluid-base">
        <div class="sidebar-layout sidebar-layout--expanded" x-data="{ mobileMenuOpen: false }">
            {{-- Barra superior móvil/tablet: logo + menú hamburguesa (solo < lg) --}}
            ...
            <div class="sidebar-layout__main bg-white">
                {{-- Encabezado de página con degradado azul --}}
                @isset($header)
        ...
        <script>
        (function() {
            var badgeWrap = document.getElementById('sidebar-notification-badge-wrap');
            var badge = document.getElementById('sidebar-notification-badge');
            if (!badgeWrap || !badge) return;
            ...
            function updateBadge() {
                fetch(url, { headers: { 'Accept': 'application/json', 'X-Requested-With': 'XMLHttpRequest' } })
                    ...
                    .then(function(data) {
                        ...
                        badgeWrap.style.display = count > 0 ? '' : 'none';
                    })
                    .catch(function() {});
            }
            updateBadge();
