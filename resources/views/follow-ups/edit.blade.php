                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select id="contact_id" name="contact_id" class="mt-1 block w-full rounded-md border-gray-300">
                                ...
                                <option value="{{ $contact->id }}" {{ old('contact_id', $followUp->contact_id) == $contact->id ? 'selected' : '' }}>{{ $contact->nombre_completo }} - {{ $contact->company?->nombre_comercial ?? 'Sin empresa' }}</option>
                                @endforeach
                            </select>
