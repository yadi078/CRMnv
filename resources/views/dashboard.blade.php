<x-app-layout>
    ...
    <div class="space-y-8">
            ...
            <!-- Estatus de prospectos (por contactos) - Semáforo -->
            <div class="panel-card-dark">
                <h3 class="panel-card-dark__title panel-card-dark__title--spaced section-title-underline">Estatus de prospectos (contactos)</h3>
