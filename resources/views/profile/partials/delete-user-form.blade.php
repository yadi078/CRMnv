<section class="space-y-6 sm:space-y-8">
    <header class="flex items-start gap-5">
        <div class="flex-shrink-0 w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-red-500/20 flex items-center justify-center ring-2 ring-red-400/50">
            <svg class="w-6 h-6 sm:w-7 sm:h-7 text-red-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
